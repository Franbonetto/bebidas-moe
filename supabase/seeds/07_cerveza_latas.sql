...
select p.id, v.nombre_sku, v.codigo, 'pack', v.volumen, 'ml', v.unidades,
  (select id from skus where codigo_interno = v.padre),
  case when v.padre is null then null else 4 end
from (values
  ('Estrella Galicia', 'Estrella Galicia', 'Estrella Galicia Pack x6 · 473cc', 'CERVEZA-LATA-ESTRELLAGALICIA-473-X6', 473, 6, null),
  ('Antares', 'Antares', 'Antares Pack x6 · 473cc', 'CERVEZA-LATA-ANTARES-473-X6', 473, 6, null),
  ('Imperial Lager', 'Imperial', 'Imperial Lager Pack x6 · 473cc', 'CERVEZA-LATA-IMPLAGER-473-X6', 473, 6, 'CERVEZA-LATA-IMPLAGER-473-X24'),
  ('Imperial Golden', 'Imperial', 'Imperial Golden Pack x6 · 473cc', 'CERVEZA-LATA-IMPGOLDEN-473-X6', 473, 6, 'CERVEZA-LATA-IMPGOLDEN-473-X24'),
  ('Imperial Roja', 'Imperial', 'Imperial Roja Pack x6 · 473cc', 'CERVEZA-LATA-IMPROJA-473-X6', 473, 6, 'CERVEZA-LATA-IMPROJA-473-X24'),
  ('Imperial Negra', 'Imperial', 'Imperial Negra Pack x6 · 473cc', 'CERVEZA-LATA-IMPNEGRA-473-X6', 473, 6, 'CERVEZA-LATA-IMPNEGRA-473-X24'),
  ('Imperial Ipa', 'Imperial', 'Imperial Ipa Pack x6 · 473cc', 'CERVEZA-LATA-IMPIPA-473-X6', 473, 6, 'CERVEZA-LATA-IMPIPA-473-X24'),
  ('Schneider', 'Schneider', 'Schneider Pack x6 · 473cc', 'CERVEZA-LATA-SCHNEIDER-473-X6', 473, 6, 'CERVEZA-LATA-SCHNEIDER-473-X24'),
  ('Schneider Limón', 'Schneider', 'Schneider Limón Pack x6 · 473cc', 'CERVEZA-LATA-SCHNEIDERLIMON-473-X6', 473, 6, null),
  ('Grolsch', 'Grolsch', 'Grolsch Pack x6 · 473cc', 'CERVEZA-LATA-GROLSCH-473-X6', 473, 6, 'CERVEZA-LATA-GROLSCH-473-X24'),
  ('Amstel', 'Amstel', 'Amstel Pack x6 · 473cc', 'CERVEZA-LATA-AMSTEL-473-X6', 473, 6, 'CERVEZA-LATA-AMSTEL-473-X24'),
  ('Heineken', 'Heineken', 'Heineken Pack x6 · 473cc', 'CERVEZA-LATA-HEINEKEN-473-X6', 473, 6, 'CERVEZA-LATA-HEINEKEN-473-X24'),
  ('Quilmes 1890', 'Quilmes', 'Quilmes 1890 Pack x6 · 473cc', 'CERVEZA-LATA-QUILMES1890-473-X6', 473, 6, 'CERVEZA-LATA-QUILMES1890-473-X24'),
  ('Andes Roja', 'Andes', 'Andes Roja Pack x6 · 473cc', 'CERVEZA-LATA-ANDESROJA-473-X6', 473, 6, 'CERVEZA-LATA-ANDESROJA-473-X24'),
  ('Andes Negra', 'Andes', 'Andes Negra Pack x6 · 473cc', 'CERVEZA-LATA-ANDESNEGRA-473-X6', 473, 6, 'CERVEZA-LATA-ANDESNEGRA-473-X24'),
  ('Schneider', 'Schneider', 'Schneider Pack x6 · 710cc', 'CERVEZA-LATA-SCHNEIDER-710-X6', 710, 6, 'CERVEZA-LATA-SCHNEIDER-710-X24'),
  ('Heineken', 'Heineken', 'Heineken Pack x6 · 710cc', 'CERVEZA-LATA-HEINEKEN-710-X6', 710, 6, 'CERVEZA-LATA-HEINEKEN-710-X24'),
  ('Quilmes 1890', 'Quilmes', 'Quilmes 1890 Pack x4 · 710cc', 'CERVEZA-LATA-QUILMES1890-710-X4', 710, 4, 'CERVEZA-LATA-QUILMES1890-710-X16')
) as v(producto, marca, nombre_sku, codigo, volumen, unidades, padre)
join marcas m on m.nombre = v.marca
join productos p on p.marca_id = m.id and p.nombre = v.producto;
...
from (values
  ('Estrella Galicia', 'Estrella Galicia', 'Estrella Galicia 473cc', 'CERVEZA-LATA-ESTRELLAGALICIA-473-UN', 'CERVEZA-LATA-ESTRELLAGALICIA-473-X6'),
  ('Antares', 'Antares', 'Antares 473cc', 'CERVEZA-LATA-ANTARES-473-UN', 'CERVEZA-LATA-ANTARES-473-X6'),
  ('Imperial Lager', 'Imperial', 'Imperial Lager 473cc', 'CERVEZA-LATA-IMPLAGER-473-UN', 'CERVEZA-LATA-IMPLAGER-473-X6'),
  ('Imperial Golden', 'Imperial', 'Imperial Golden 473cc', 'CERVEZA-LATA-IMPGOLDEN-473-UN', 'CERVEZA-LATA-IMPGOLDEN-473-X6'),
  ('Imperial Roja', 'Imperial', 'Imperial Roja 473cc', 'CERVEZA-LATA-IMPROJA-473-UN', 'CERVEZA-LATA-IMPROJA-473-X6'),
  ('Imperial Negra', 'Imperial', 'Imperial Negra 473cc', 'CERVEZA-LATA-IMPNEGRA-473-UN', 'CERVEZA-LATA-IMPNEGRA-473-X6'),
  ('Imperial Ipa', 'Imperial', 'Imperial Ipa 473cc', 'CERVEZA-LATA-IMPIPA-473-UN', 'CERVEZA-LATA-IMPIPA-473-X6'),
  ('Schneider', 'Schneider', 'Schneider 473cc', 'CERVEZA-LATA-SCHNEIDER-473-UN', 'CERVEZA-LATA-SCHNEIDER-473-X6'),
  ('Schneider Limón', 'Schneider', 'Schneider Limón 473cc', 'CERVEZA-LATA-SCHNEIDERLIMON-473-UN', 'CERVEZA-LATA-SCHNEIDERLIMON-473-X6'),
  ('Grolsch', 'Grolsch', 'Grolsch 473cc', 'CERVEZA-LATA-GROLSCH-473-UN', 'CERVEZA-LATA-GROLSCH-473-X6'),
  ('Amstel', 'Amstel', 'Amstel 473cc', 'CERVEZA-LATA-AMSTEL-473-UN', 'CERVEZA-LATA-AMSTEL-473-X6'),
  ('Heineken', 'Heineken', 'Heineken 473cc', 'CERVEZA-LATA-HEINEKEN-473-UN', 'CERVEZA-LATA-HEINEKEN-473-X6'),
  ('Quilmes 1890', 'Quilmes', 'Quilmes 1890 473cc', 'CERVEZA-LATA-QUILMES1890-473-UN', 'CERVEZA-LATA-QUILMES1890-473-X6'),
  ('Andes Roja', 'Andes', 'Andes Roja 473cc', 'CERVEZA-LATA-ANDESROJA-473-UN', 'CERVEZA-LATA-ANDESROJA-473-X6'),
  ('Andes Negra', 'Andes', 'Andes Negra 473cc', 'CERVEZA-LATA-ANDESNEGRA-473-UN', 'CERVEZA-LATA-ANDESNEGRA-473-X6')
